...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2020-07-07T05:47:13.537Z[GMT]")public class QuestionsApi  {
   ...
   public QuestionsApi(@Context ServletConfig servletContext) {
    ...
    public Response getQuestion(@Parameter(in = ParameterIn.QUERY, description = "UUID assigned to the player.",required=true) @QueryParam("playerId") String playerId
