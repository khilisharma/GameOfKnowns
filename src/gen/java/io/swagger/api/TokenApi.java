...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2020-07-07T05:47:13.537Z[GMT]")public class TokenApi  {
   ...
   public TokenApi(@Context ServletConfig servletContext) {
    ...
    public Response describeToken(@Parameter(in = ParameterIn.QUERY, description = "Unique identifier returned to a player needed to retrieve gameId and playerId",required=true) @QueryParam("tokenId") String tokenId
